...
<body>
    ...
    <nav class="navbar navbar-expand-lg pt-3 pb-3" style="background-color:#164B80">
        ...
        <div class="navbar-text">
            <a class="navbar-text text-white btn btn-success active mr-2" href="#ex2" rel="modal:open" type="button">
    ...
    <div class="modal " id="ex2" style="height: auto; position: relative;">
