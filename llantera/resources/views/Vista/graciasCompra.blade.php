...
<body>
    ...
    <main>
        <h1 class="text-center" style=" color: #164B80; font-family: Space Ranger Academy;">¡muchas gracias por tu compra!</h1>
        <h2 class="text-center" style=" color: #164B80; font-family: Space Ranger Academy;">¡tu compra fue realizado con éxito!</h2>
        <br>
        <center><img src="imagenes/exito2.png" alt=""></center>
        <h3 class="text-center" style=" color: #000000; font-family: Space Ranger Academy; ">Tu pedido a sido recibido y será despachado proximamente </h3>
        <h3 class="text-center" style=" color: #000000; font-family: Space Ranger Academy;">Si tienes dudas o comentarios no olvides comunicarte con nosotros</h3>
        <br>
        <center><a href="{{url ('vistaProductosU2')}}"><input class="btn btn-outline-primary" name="seguir" value="Seguir comprando"></a></center>
