...
<body>
    ...
    <main>
        <h1 class="text-center" style=" color: #164B80; font-family: Space Ranger Academy;">actualizacion de datos del empleado</h1>
        <br>

        <form class="" action="{{ url('actualizarEmpleado') }}" method="post">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-6">
                        Nombre: <input type="text" maxlength="30" class="form-control" name="nombre" value="{{$empleado->nombre}}">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        Apellido: <input type="text" maxlength="30" class="form-control" name="apellido" value="{{$empleado->apellido}}">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        Telefono: <input type="text" maxlength="10" class="form-control" pattern="[0-9]+" name="telefono" value="{{$empleado->telefono}}">
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-6">
                        Correo: <input type="text" maxlength="30" class="form-control" name="correo" value="{{$empleado->correo}}">
                    </div>
                </div>
                <br>
                <div class="row">
