        ...
        <div class="card">
            <div class="card">
                <div class="card-header">
                        ...
                        <div class="col-6 ">
                            <div class="card">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    Lista de Empleados en PDF
                                    <a href="{{ URL::to('pdf-empleado') }}" class="btn btn-danger btn-sm">Crear</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="card">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    Lista de Empleados en formato CSV
                                    <a href="{{ URL::to('csv-empleado')  }}" class="btn btn-primary btn-sm">Crear</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="row">
                        <span><i class="bi bi-table me-2" style="font-size:large;"></i></span> LISTADO DE EMPLEADOS
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <table id="example" class="table table-striped data-table text-center">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" colspan="2">Accion</td>
                                </tr>
                            </thead>
                            @foreach($nombre as $x)
                            <tr>
                                ...
                                <td>{{$x->telefono}}</td>
                                <td>{{$x->correo}}</td>
                                <td><a type="botton" class="btn btn-outline-primary" href="../editarEmpleado/{{$x->idEmpleado}}">Editar</a></td>
                                <td><a type="botton" class="btn btn-outline-danger" href="../eliminarEmpleado/{{$x->idEmpleado}}">Eliminar</a></td>
                            </tr>
                            @endforeach
                        </table>
                    </div>
