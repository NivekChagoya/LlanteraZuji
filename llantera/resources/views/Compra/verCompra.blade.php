...
<body>
    ...
    <main>
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <span><i class="bi bi-table me-2" style="font-size:large;"></i></span> LISTADO DE COMPRAS
                </div>
            </div>
            <div class="card-body">
    ...
    <footer class="navbar navbar-expand-lg navbar-dark text-white" style="width: 100%; position: absolute; bottom: 0; left: 0; background-color:#164B80">
